<a href="{{ route($url.'edit', $model->id) }}" title="Edit Permission" class="btn btn-md btn-link">
    <i class="fa fa-edit"></i>
</a>

<a class="btn btn-md btn-link" title="Delete Permission" data-toggle="modal" href="#modal-{{ $model->id }}">
