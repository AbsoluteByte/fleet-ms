@extends('layouts.admin', ['title' => 'Insurance Providers'])
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('insurance-providers.show', $insuranceProvider) }}" class="btn btn-sm btn-outline-info">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('insurance-providers.edit', $insuranceProvider) }}" class="btn btn-sm btn-outline-warning">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('insurance-providers.destroy', $insuranceProvider) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center text-muted py-4">
                                                ...
                                                <br>
                                                No agreements found. <a href="{{ route('insurance-providers.create') }}">Create your first agreement</a>
                                            </td>
                                        </tr>
                                    @endforelse
                                    </tbody>
